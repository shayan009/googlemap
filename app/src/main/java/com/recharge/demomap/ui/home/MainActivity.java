...
public class MainActivity extends AppCompatActivity
                            ...
                            switch (status.getStatusCode()) {
                                case LocationSettingsStatusCodes.SUCCESS:
                                    ...
                                    if (permissionLocation == PackageManager.PERMISSION_GRANTED) {
                                        ...
                                        if(mylocation!=null){
                                            Log.w(TAG, "onLocationChanged1: "+mylocation.getLatitude()+"//"+mylocation.getLongitude() );
                                           // options.position(new LatLng(mylocation.getLatitude(),mylocation.getLongitude()));
                                            mNavigationManager.showHomeFragment(mylocation);
                                        }else{
                                            getMyLocation();
                                        }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location != null) {
            ...
            Log.w(TAG, "onLocationChanged2: "+latitude+"//"+longitude );
